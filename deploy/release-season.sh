...
# cv-release-season — merge seasonal mascot + Rive infrastructure PR, then deploy.
#
#   sudo ln -sf /var/www/calorie-vision/deploy/release-season.sh /usr/local/bin/cv-release-season
#   cv-release-season
#   cv-release-season 262
...
echo "==> Mascot seasonal / Rive release: ${PRS[*]}"
...
echo "==> Seasonal mascot release done"
