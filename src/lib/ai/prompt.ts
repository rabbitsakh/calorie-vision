...
- alternatives: 1-3 варианта, если продукт неочевиден; иначе []. Указывай calories, protein, fat, carbs, portionGrams для каждого варианта — тогда клик не требует дополнительного запроса
