...
const TITLE_TRANSLATIONS: Array<[RegExp, string]> = [
  [/^fix\(ui\): avatar menu clipped on desktop$/i, "Исправление: меню по аватару больше не обрезается на десктопе"],
  ...
  [/^Recognition 50-point wave 9.*$/i, "Распознавание: live eval cron, drill-down слабых позиций, фикстуры"],
  [/^Recognition 50-point wave 8.*$/i, "Распознавание: таблица fiber/sugar, фикстуры, UX слабых позиций"],
  ...
  [/^fix: secure meal photos.*$/i, "Безопасность фото, OFF lookup, серия/вес, UX распознавания и празднований"],
  [/^Audit batch.*10 PR.*$/i, "Аудит: безопасность, распознавание, рацион, серия, празднования, деплой"],
  [/^Mascot blob-leaf redesign.*$/i, "Маскот: круглый blob с ростком сверху (без боковых «усов»)"],
  [/^Mascot plan wave 1.*$/i, "Маскот: тесты поз и motion-классов"],
  [/^Mascot plan wave 2.*$/i, "Маскот: общая карточка компаньона в рационе"],
  [/^Mascot plan wave 3.*$/i, "Лендинг: маскот в двух местах — «Бесплатно» и финальный CTA"],
  [/^Mascot plan wave 4.*$/i, "Маскот: пустой дневник — дружелюбный текст и pose empty"],
  [/^Mascot plan wave 5.*$/i, "Маскот: push-промпт с талисманом"],
  [/^Mascot plan wave 6.*$/i, "Celebration: явные variant goal для целей дня"],
  [/^Mascot plan wave 7.*$/i, "Маскот: streak-nudge через MascotCompanionCard"],
  [/^Mascot plan wave 8.*$/i, "Маскот: dev preview celebration и лендинга"],
  [/^Mascot plan wave 9.*$/i, "Маскот: changelog для batch-релиза"],
  [/^Mascot plan wave 10.*$/i, "Деплой: cv-release-mascot для 10 PR"],
  [/^Mascot lively wave 1.*$/i, "Маскот: face engine — моргание и взгляд"],
  [/^Mascot lively wave 2.*$/i, "Маскот: squash/stretch на cheer как у Duo"],
  [/^Mascot lively wave 3.*$/i, "Маскот: idle reel — look, yawn, stretch, wave"],
  [/^Mascot lively wave 4.*$/i, "Маскот: tap-to-pet"],
  [/^Mascot lively wave 5.*$/i, "Celebration: звук и haptic"],
  [/^Mascot lively wave 6.*$/i, "Маскот: реакция «Записано!» после сохранения еды"],
  ...
  [/^Mascot Duo season.*$/i, "Маскот: сезонныe луки в духе Duo + НГ/Хэллоуин, плавный pet"],
  [/^Mascot season duo.*$/i, "Маскот: сезонныe луки в духе Duo + НГ/Хэллоуин, плавный pet"],
  [/^Mascot holiday.*$/i, "Маскот: праздничные луки (23 фев, 8 мар, 14 фев, космос, 9 мая, 1 сен)"],
