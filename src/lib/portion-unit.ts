...
const DRINK_TOKEN =
  "напиток|нектар|сок|чай|кофе|молоко|молочн\\w*|кефир|ряженк\\w*|пиво|вино|вода|лимонад|кола|cola|coca|pepsi|sprite|fanta|smoothie|смузи|компот|морс|какао|квас|латте|капучино|эспрессо|американо|энергетик\\w*|lipton|schweppes|швеппс|red\\s*bull|ред\\s*булл|actimel|имунеле";
