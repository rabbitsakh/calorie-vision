...
const DRINK_TOKEN =
  "напиток|нектар|сок|чай|кофе|молоко|молочн\\w*|кефир|ряженк\\w*|пиво|вино|вода|лимонад|тоник|tonic|кола|cola|coca|pepsi|sprite|fanta|smoothie|смузи|компот|морс|какао|квас|латте|капучино|эспрессо|американо|энергетик\\w*|lipton|schweppes|швеппс|red\\s*bull|ред\\s*булл|actimel|имунеле";

const DRINK_PHRASE =
  "йогурт\\s+пить|питьевой\\s+йогурт|йогурт\\s+питьевой|питьевой\\s+молочн\\w*|drinkable\\s+yogurt|yogurt\\s+drink";
