...
import { applyFiberSugarOverrides, calorieTone, compareNutrient, DIET_PROFILE_SELECT, explainDiet, formatGoalChoice, isActivityLevel, isSex, isWeightGoal, round1, type GoalPace } from "@/lib/diet";
