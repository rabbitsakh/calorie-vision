...
const AUTH_ERRORS: Record<string, string> = {
  ...
  OAuthCallback: "Google отклонил вход. Проверьте Redirect URI в консоли Google.",
  OAuthCreateAccount: "Не удалось создать аккаунт Google.",
  ...
  Configuration: "Вход через Google не настроен на сервере.",
  AccessDenied: "Доступ через Google запрещён.",
...
export default function LoginForm() {
  ...
  function handleGoogleLogin() {
    setLoading(true);
    setError(null);
    void signIn("google", { callbackUrl: withBasePath("/") });
  }
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-12">
      <div className="card p-8">
        ...
        <p className="mt-2 text-slate-600">
          Войдите по номеру телефона или email, чтобы сохранять дневник питания.
        </p>
