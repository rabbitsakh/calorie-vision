const AUDIENCES = [
  ...
  {
    title: "Набор массы",
    text: "Следите за белком и калориями после тренировок — быстрый повтор и избранное экономят время.",
    points: ["белок на кольце", "быстрый лог", "избранные блюда"],
  },
  {
    title: "Баланс и привычка",
    text: "Не обязательно «диета» — понимать, что вы едите, и не бросать дневник через три дня.",
    points: ["серия без штрафов", "план недели", "вода и БЖУ"],
  },
] as const;
